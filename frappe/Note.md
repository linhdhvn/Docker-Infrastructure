...
docker build --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe --build-arg=FRAPPE_BRANCH=version-15 --secret=id=apps_json,src=apps.json --tag=frappe/erpnext-custom:v15 --file=images/production/Containerfile .
